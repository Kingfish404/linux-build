...
# Keep downloaded, hash-checked sources: recent upstream distclean deletes dl/.
clean_buildroot_outputs: buildroot
	make -C $(BUILDROOT_DIR) clean

# Defconfig is regenerated by make_initramfs_buildroot, so distclean is unnecessary.
make_initramfs_buildroot_clean: clean_buildroot_outputs ## Rebuild Buildroot initramfs from scratch, preserving downloads
	$(MAKE) make_initramfs_buildroot

.PHONY: clean_buildroot_outputs
